          ...
          <Row className="g-gs">
            <Col md="5">
              ...
              <PreviewAltCard className="card-full">
                ...
                <div className="flex justify-between font-semibold ">
                  <h6 className="subtitle mt-3 text-slate-600">Balance:</h6>
                ...
                <div className="border border-secondary-subtle p-2 rounded-pill">
                  <input
                    type="number"
                    min={0}
            ...
            <Col md="7" xxl="6">
              <table className="w-full">
                <tr className="flex justify-between px-3 text-slate-800 font-semibold ">
                  <td>Asset</td>
                  <td>Price</td>
                  <td>24h Change</td>
                  <td>Amount</td>
                ...
                <tr className="mt-3 p-4 bg-white flex justify-between border">
                  <td>DOGE</td>
                  <td>0.00</td>
                  <td className="bg-secondary-red text-primary-red px-3 border rounded">-9.2%</td>
                  <td>0.00</td>
                  <td>$0.00</td>
                </tr>
                <tr className="mt-3 p-4 bg-white flex justify-between border">
